    ...
    <div class="bg-white shadow-xl rounded-lg p-6">
        ...
        <div class="mt-6 flex justify-end">
            <button wire:click="exportToExcel" 
                    class="bg-green-600 text-white mb-4 px-4 py-2 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed">
